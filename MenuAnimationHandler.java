/** 
 * Filename:    MenuAnimationHandler.java 
 * Description:  
 ...
 * -----------------------------------------------------
 * 2015-5-18   chijianfeng      1.0         1.0 Version 
 */
...
public abstract class MenuAnimationHandler {
	...
	/**
	 * define the Menu action type
	 * */
	protected enum ActionType {OPENING, CLOSING};
	
	protected FloatActionMenu menu;
     ...
     */
    @SuppressLint("NewApi")
	protected void restoreSubActionViewAfterAnimation(FloatActionMenu.Item subActionItem, ActionType actionType) {
